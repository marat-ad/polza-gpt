...
7. Формат начала сообщения:
   ${requestShowAll 
     ? '- Начни сразу со списка, БЕЗ вводной фразы'
     : `- Если найдено 5 или меньше экспертов: начни сразу со списка, БЕЗ вводной фразы о количестве
   - Если найдено больше 5 экспертов: начни с "Найдено много совпадений, вот топ-5"`}
